...
Sou **Engenheiro Florestal** e **Analista de Operações** na Growth Machine, com foco em **Prospecção com IA** e **Growth**. Minha paixão reside em unir a gestão de recursos naturais à inteligência de mercado e à tecnologia, especialmente a automação de processos.

Possuo experiência prática na aplicação de **soluções baseadas na natureza (ESG)** e na otimização de fluxos de trabalho, transformando dados em oportunidades de crescimento. Sou um entusiasta de florestas, tecnologia e inovação, sempre buscando trocar conhecimentos e criar arquiteturas que impulsionem o sucesso do cliente e o empreendedorismo.
...
| Categoria | Detalhe |
| :--- | :--- |
| 🎓 **Formação** | Bacharelado em Engenharia Florestal pela UFSJ (Jan 2016 - Jan 2026). |
| 🧠 **Foco** | Prospecção com IA (SDR), Análise de Operações, ESG e Soluções Baseadas na Natureza. |
| 🛠️ **Stack Principal** | CRM, Python, Social Selling, Ferramentas de IA para Vendas. |
| 💡 **Missão** | Conectar a ciência florestal com a inteligência de mercado para impulsionar o crescimento sustentável. |

---

### &nbsp; Artigo Científico em Destaque

Meu trabalho acadêmico demonstra a aplicação de tecnologia de ponta para resolver problemas ambientais complexos.

#### **UM MÉTODO SIMPLES E RÁPIDO PARA IDENTIFICAR OS LIMITES DE FRAGMENTOS FLORESTAIS**
...
*Linguagens & Core*<br>
<img src="https://skillicons.dev/icons?i=python,sql,js,r" />
...
Esta seção está pronta para receber seus projetos mais relevantes. Sugiro incluir projetos que demonstrem suas habilidades em **Prospecção com IA**, **Análise de Operações** ou **Soluções Geoespaciais/ESG**.

<!-- Exemplo de Estrutura de Projeto (Removido o conteúdo original para personalização)
### 1. [Nome do Projeto](Link do Projeto)
> Tags | Tecnologias
...
Estou sempre aberto a conversar sobre tecnologia, florestas, dados e estratégias de crescimento.
...
<div align="center">
  <sub><i>"Conectando a ciência da floresta com a inteligência de mercado para impulsionar o crescimento."</i></sub>
</div>
